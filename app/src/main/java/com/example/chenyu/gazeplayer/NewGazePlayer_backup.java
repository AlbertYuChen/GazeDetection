...
public class NewGazePlayer_backup extends Activity implements CameraBridgeViewBase.CvCameraViewListener2, SurfaceHolder.Callback, MediaPlayer.OnPreparedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        button_switch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (resolution_H_L == true) {
                    switch_video(Video_L, 11110);
                    resolution_H_L = false;
                } else {
