...
//
////        mOpenCvCameraView.setMaxFrameSize(400,200);
//
//    }
//
//    @Override
...
//
//            // split it
//            Rect eyearea_right = new Rect(r.x + r.width / 10,
//                    (int) (r.y + (r.height / 4.5)),
//                    (r.width - 2 * r.width / 10) / 2, (int) (r.height / 3.0));
//
//            Rect eyearea_left = new Rect(r.x + r.width / 10
//                    + (r.width - 2 * r.width / 10) / 2,
//                    (int) (r.y + (r.height / 4.5)),
//                    (r.width - 2 * r.width / 10) / 2, (int) (r.height / 3.0));
//
